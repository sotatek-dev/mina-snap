...
const CardAccount: React.FC<Props>  = ({active, imported}) => {
    return (
        <Wrapper active={active}>
            <AccountName active={active}>
                <Label>
                    Account 1
                    <Imported active={active} imported={imported}>Imported</Imported>
                </Label>
                <IconActive active={active}/>
            </AccountName>
            <Address active={active}>B62qjRUXXT...8VdbDnnr6k</Address>
            <Balance active={active}>
                0 MINA
                <More active={active} typeButton="round"><PointMenu src={active ? pointMenu: pointMenuDark} /></More>
            </Balance>
        </Wrapper>
